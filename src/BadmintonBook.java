...
public class BadmintonBook extends javax.swing.JFrame {
    ...
    public BadmintonBook() {
        initComponents();
        String sql = String.format("SELECT id,Name,Phone,Date,Time FROM schedule WHERE sport='%s' AND court = '%s'","Badminton","1");
        setTable(sql,jTable1);
        String sql2 = String.format("SELECT id,Name,Phone,Date,Time FROM schedule WHERE sport='%s' AND court = '%s'","Badminton","2");
        setTable(sql2,court2table);
        String sql3 = String.format("SELECT id,Name,Phone,Date,Time FROM schedule WHERE sport='%s' AND court = '%s'","Badminton","3");
        setTable(sql3,court3table);
        String sql4 = String.format("SELECT id,Name,Phone,Date,Time FROM schedule WHERE sport='%s' AND court = '%s'","Badminton","4");
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/bmdwhite.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int a = JOptionPane.showConfirmDialog(null,"Do you really want to delete this Id '?", "Select",JOptionPane.YES_NO_OPTION);
            if(a == 0){
                try{
                    DBConnect db =new DBConnect();
                    String sql = String.format("DELETE FROM schedule WHERE id='%s' AND sport = '%s' AND court = '%s' ",id,"Badminton","1");
                    db.getUpdate(sql);
                    db.disconnect();
    ...
    private void addBt2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBt2ActionPerformed
        ...
        String sql = String.format("SELECT id,Name,Phone,Date,Time FROM schedule WHERE sport='%s' AND court = '%s'","Badminton","3");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int a = JOptionPane.showConfirmDialog(null,"Do you really want to delete this Id '?", "Select",JOptionPane.YES_NO_OPTION);
            if(a == 0){
                try{
                    DBConnect db =new DBConnect();
                    String sql = String.format("DELETE FROM schedule WHERE id='%s' AND sport = '%s' AND court = '%s' ",id,"Badminton","3");
                    db.getUpdate(sql);
                    db.disconnect();
    ...
    private void addBt3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBt3ActionPerformed
        ...
        String sql = String.format("SELECT id,Name,Phone,Date,Time FROM schedule WHERE sport='%s' AND court = '%s'","Badminton","4");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int a = JOptionPane.showConfirmDialog(null,"Do you really want to delete this Id '?", "Select",JOptionPane.YES_NO_OPTION);
            if(a == 0){
                try{
                    DBConnect db =new DBConnect();
                    String sql = String.format("DELETE FROM schedule WHERE id='%s' AND sport = '%s' AND court = '%s' ",id,"Badminton","4");
                    db.getUpdate(sql);
                    db.disconnect();
    ...
    private void addBt4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBt4ActionPerformed
        ...
        String sql = String.format("SELECT id,Name,Phone,Date,Time FROM schedule WHERE sport='%s' AND court = '%s'","Badminton","2");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        int a = JOptionPane.showConfirmDialog(null,"Do you really want to delete this Id '?", "Select",JOptionPane.YES_NO_OPTION);
            if(a == 0){
                try{
                    DBConnect db =new DBConnect();
                    String sql = String.format("DELETE FROM schedule WHERE id='%s' AND sport = '%s' AND court = '%s' ",id,"Badminton","2");
                    db.getUpdate(sql);
                    db.disconnect();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BadmintonBook().setVisible(true);
